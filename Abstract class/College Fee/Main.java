...
public static void main(String[] args) {
 ...
 DayScholar dayScholar=new DayScholar(studentId, name, deptName, gender,category, collegeFee, busNumber, distance);
 ...
 Hosteller hosteller=new Hosteller(studentId,name,deptName,gender,category,collegeFee,roomNumber,blockName,roomType);
